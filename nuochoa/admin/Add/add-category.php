...
<form id="" method="post">
      ...
      <div class="col-sm-10">
         <div class="form-row">
            <div class="form-group col-md-6">
               <input type="text" class="form-control" placeholder="FM" name="maLoai" >
            </div>
            <div class="form-group col-md-6">
               <input type="text" class="form-control" placeholder="For men" name="tenLoai">
            </div>
         </div>
      </div>
   </div>
   ...
   <div class="form-group row">
      ...
      <div class="col-sm-10">
         <textarea class="form-control" id="exampleFormControlTextarea1" rows="3" name="motaLoai"></textarea>
      </div>
   </div>
   <div class="form-group row">
